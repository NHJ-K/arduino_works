...
const int WHEEL_DIAMETER = 18; // please enter the wheel diameter in inches (or centimeters if USE_MPH is set to false)
...
void loop()
{
    ...
    thisMagValue = analogRead(Hall_Sensor);// The value of the Hall Sensor right now
